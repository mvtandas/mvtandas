...
**Lead Frontend Developer** @ OneNewOne | İstanbul, Turkey

4.500+ commit ile 15+ mikro-frontend repodan oluşan bir İK/SaaS platformunun frontend mimarisini tasarlıyor ve geliştiriyorum. AI entegrasyonları, WebRTC video sistemleri ve gerçek zamanlı uygulamalar konusunda deneyimliyim.

- 🔭 Şu an **OneNewOne** İK SaaS platformunda çalışıyorum
- 🤖 AI entegrasyonları (Claude, Gemini, OpenAI) ile ürün geliştiriyorum
- 📱 React Native ile cross-platform mobil uygulamalar yapıyorum
- 🎯 150+ freelance projeyi başarıyla teslim ettim
- 🌍 Vue Router, TanStack Query, VueUse, React Docs, Python Docs'a aktif katkı sağlıyorum
...
![Google AI](https://img.shields.io/badge/Gemini-4285F4?style=flat-square&logo=google&logoColor=white)
...
|:-----:|----------|:------------:|
| [**📈 BistBase**](https://github.com/mvtandas/bistbase) | AI destekli borsa analiz ve backtesting platformu | `Next.js 16` `Claude SDK` `PostgreSQL` `Redis` |
| [**🥋 Kuras**](https://github.com/mvtandas/kuras-frontend) | IJF kurallarına uygun judo turnuva yönetim sistemi | `Vue.js 3` `Node.js` `MongoDB` |
| [**💊 TimeCapsule**](https://github.com/mvtandas/timecapsule) | Konum bazlı dijital zaman kapsülü mobil uygulaması | `React Native` `Expo` `Supabase` |
| [**🎯 Lead Gen SaaS**](https://github.com/mvtandas/lead-generation-saas) | AI destekli lead generation platformu | `React 19` `TypeScript` `Gemini` |
| [**🌐 Synapeer**](https://github.com/mvtandas/synapeer) | AI danışmanlık firması kurumsal websitesi | `Next.js 14` `React 19` `shadcn/ui` |
| [**🤖 Papyon AI**](https://github.com/mvtandas/papyon-ai-frontend) | AI uygulama keşif ve yönetim platformu | `Vue 3` `Node.js` `Tailwind` |
| [**📊 InstFollowers**](https://github.com/mvtandas/InstFollowers) | Instagram takipçi analitik Chrome eklentisi | `Chrome API` `Manifest V3` |
| [**🎮 Oziyi Kurtar**](https://github.com/mvtandas/oziyi-kurtar) | Pixel splash mekanikli idle/clicker oyunu | `React 19` `TypeScript` |
...
|:-------:|:------------|:--:|
| ![Vue](https://img.shields.io/badge/-Vue_Router-4FC08D?style=flat-square&logo=vuedotjs&logoColor=white) **vuejs/router** | Bug fix: catch-all redirect param warning | [#2683](https://github.com/vuejs/router/pull/2683) |
| ![TanStack](https://img.shields.io/badge/-TanStack_Query-FF4154?style=flat-square&logo=reactquery&logoColor=white) **TanStack/query** | Bug fix: ESLint plugin TS6 TypeFlags compat | [#10484](https://github.com/TanStack/query/pull/10484) |
...
|--------|----------|-------|
| **OneNewOne** | Lead Frontend Developer | 2023 – Günümüz |
